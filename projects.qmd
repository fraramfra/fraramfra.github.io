...
---
## [Dasboard: Commuting Insights](https://github.com/UBC-MDS/DSCI-532_2025_28_commuting-insights)

"Commuting Insights" is a dahsboard developed in `Dash` in collaboration with Eugene You (@jinxyou), Derek Rodgers (@derekrodgers) and Han Wang (@hanwang205), as part of UBC's Master of Data Science program.
...
You can visit the dashboard [here](https://dsci-532-2025-28-commuting-insights.onrender.com/)
...
The report can be found here: [Report HTML](img/adult_income.html)